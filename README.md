...
**ML Engineer · Automotive AI · Bavaria, Germany**
...
|---|---|---|
| [ ASPICE RAG Chatbot](https://github.com/Subodh-Kurkute/aspice-rag-chatbot) | RAG chatbot over ASPICE PAM 4.0 | LLM . ChromaDB . Streamlit . Docker . AWS EC2
...
**ML & AI**
`scikit-learn` `LangChain` `RAG` `Hybrid Retrieval` `RAGAS` `Streamlit`

**Vector & Data**
`ChromaDB` `PostgreSQL` `Pandas` `NumPy`

**APIs & DevOps**
`FastAPI` `Docker` `AWS EC2` `GitHub Actions` `REST API`
